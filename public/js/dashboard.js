...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.getElementById('closeCommentsModalBtn').addEventListener('click', closeCommentsModal);
});
...
function updateFormDropdowns(optionsByType) {
  ...
  if (accountManagerSelect && optionsByType.account_managers) {
  ...
  if (statusSelect && optionsByType.statuses) {
  ...
  if (currentPhaseSelect && optionsByType.phases) {
  ...
  if (prioritySelect && optionsByType.priorities) {
  ...
  if (endMonthSelect && optionsByType.end_months) {
  ...
  if (status2Select && optionsByType.phases) {
...
function populateFilter(filterId, options) {
  ...
  filter.innerHTML = filter.querySelector('option').outerHTML;
